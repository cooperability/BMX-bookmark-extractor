...
export default function Home() {
    ...
    return (_jsxs("div", __assign({ style: {
            ...
            marginTop: "20px",
        } }, { children: [_jsxs("p", { children: [_jsx("b", { children: "Hi, I'm Cooper!" }), " Here's my", " ", _jsx("u", { children: _jsx("b", { children: _jsx("a", __assign({ href: "https://drive.google.com/file/d/197fniv8a0-iVVzl_aiwSBl6NaFnTppnz/view?usp=sharing" }, { children: "Resume." })) }) }), "\u00A0I\u2019ve been creating software for six years, music five, web3 three, and NLP two.", _jsx("br", {}), _jsx("br", {}), "To me, ", _jsx("b", { children: "Co-Operability" }), " means long-term synergy between my ambitions and morals. For me, that means open-sourcing all my projects and turning my hours into free education for others.", _jsx("br", {}), _jsx("br", {})] }), _jsxs("div", __assign({ className: "flex justify-between" }, { children: [_jsx("b", { children: "A quote that speaks to me:" }), _jsx("span", { children: "\u00A0\u00A0" }), _jsx("button", __assign({ className: "py-1 px-1 rounded flex text-lg border", onClick: function () {
                            return setQuote(quotes[Math.floor(Math.random() * quotes.length)]);
                        } }, { children: "Randomize" })), _jsx("span", __assign({ suppressHydrationWarning: true }, { children: quote }))] }))] })));
}
