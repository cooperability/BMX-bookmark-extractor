...
/** What a node is to the player. Cards are rooms you earn; decks and tags are the halls between them. */
export type Facet = 'card' | 'deck' | 'tag';
 ...
 * try when FSRS says it is due.
 */
export type SealReason = 'new-cap' | 'cooling';
