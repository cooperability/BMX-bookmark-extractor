...
<aside
	class="panel flex flex-col gap-3 bg-surface-2/60 px-5 py-4 text-sm"
...
>
	...
	{#if prior.weak.length}
		<div class="flex flex-wrap items-center gap-1.5">
			<span class="mr-1 text-xs text-muted">Weak</span>
	...
	{#if prior.strong.length}
		<div class="flex flex-wrap items-center gap-1.5">
			<span class="mr-1 text-xs text-muted">Strong</span>
