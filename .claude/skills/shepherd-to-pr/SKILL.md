...
- Dispatch each stage with the Task tool, passing `model` per the pricing table. Separate agents for implementation, review, and grading — the isolation is what makes the grade mean anything.
