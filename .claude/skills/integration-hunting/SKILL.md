...
Mine the authenticated user’s GitHub stars for OSS that would materially improve **this** local repo. Prefer GitHub MCP tools if available; otherwise use `gh` against the Stars API.
