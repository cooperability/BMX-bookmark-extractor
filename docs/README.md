...
The root README carries the systems diagram with built versus planned status, setup, and the Vercel deploy step. `./scripts/container` is the optional Docker entry point.
